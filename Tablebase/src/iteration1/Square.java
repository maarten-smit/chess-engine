...
public final class Square implements Comparable<Square> {
	...
	private boolean hasNextInDirection(Direction d) {
	...
	private Square nextInDirection(Direction d) {
	...
	public Iterable<Square> allInDirection(Direction d) {
		return new SquareSequence(d);
	}
	
	public Collection<Square> knightMoves() {
		int[][] relativeKnightMoves = new int[][] {
			new int[] {1, 2},
			new int[] {2, 1},
			new int[] {-1, 2},
			new int[] {-2, 1},
		...
		return inBounds(relativeKnightMoves);
	}
	
	public Collection<Square> kingMoves() {
		int[][] relativeKingMoves = new int[][] {
			new int[] {1, 1},
			new int[] {1, 0},
			new int[] {1, -1},
			new int[] {0, -1},
		...
		return inBounds(relativeKingMoves);
	}
	
	private Collection<Square> inBounds(int[][] deltas) {
